...
Currently, I am actively applying DevOps methodologies to bridge the gap between development and operations, leveraging a tech stack that includes AWS, Kubernetes, Docker, and CI/CD pipelines via Jenkins and GitHub. I hold an MBA in Software Project Management, a PMP certification, and the AWS Cloud Practitioner credential.
